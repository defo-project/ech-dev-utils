<?php
    ...
    $logstring = "";
    $timestr = $logstring . "|" . date(DATE_RFC3339);
    $keyedip = $logstring . "|" . do_hmac($_SERVER['HTTP_CLIENT_IP'])
    $theurl = $logstring . "|" . "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    $ech_status = $logstring . "|" . $_SERVER["SSL_ECH_STATUS"];
    $ech_inner = $logstring . "|" . $_SERVER["SSL_ECH_INNER"];
    $ech_outer = $logstring . "|" . $_SERVER["SSL_ECH_OUTER"};
    $uastring = $logstring . "|" . $_SERVER["HTTP_USER_AGENT"];
    addone($logstring);
