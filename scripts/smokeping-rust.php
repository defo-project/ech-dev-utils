...
<!-- **************************************** -->
<center>
<h1>DEfO ECH Smokeping-like Check for rustls</h1>

<p>The (server-side) script on this page displays the results from attempting
ECH (via a rustls program) with each of the URLs shown, for the time of the run shown.
...
<?php
    ...
    $topdir="/var/extra/smokeping/rustls-runs";
    ...
    $verinfo=file_get_contents($thisrun."/".$runtime.".rustls.ver");
