...
then
    ...
    then
        ...
        CODETOP=$CODETOP $EDTOP/scripts/make-example-ca.sh
    else
        CODETOP=$CODETOP $EDTOP/scripts/make-example-ca.sh >/dev/null 2>&1
    fi
fi
...
then
    ...
    case $atest in
        "yes-yes")
            ...
            client_params=" -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html"
            ;;
        "no-yes")
        ...
        "ignore-yes")
            ...
            server_params=" -w -k $scratchdir/$file $vparm "
            client_params=" -I -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html"
            ;;
        "ignore-trial")
    ...
    if [[ "$verbose" == "yes" ]]
    then
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh $server_params &
    else
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh $server_params >/dev/null 2>&1 &
    fi
    # wait a bit
    sleep $sleepb4
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh $client_params
    else
        $EDTOP/scripts/echcli.sh $client_params >/dev/null 2>&1
    fi
    cret=$?
    # kill server
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
...
do
    ...
    if [[ "$verbose" == "yes" ]]
    then
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -w -k $scratchdir/$file $vparm &
    else
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -w -k $scratchdir/$file $vparm >/dev/null 2>&1 &
    fi
    # wait a bit
    sleep $sleepb4
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html
    else
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html >/dev/null 2>&1
    fi
    cret=$?
    # kill server
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
...
do
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh -P $file -s localhost -p 8443 -H foo.example.com $vparm -f index.html
    else
        $EDTOP/scripts/echcli.sh -P $file -s localhost -p 8443 -H foo.example.com $vparm -f index.html >/dev/null 2>&1
    fi
    cret=$?
    if [[ "$cret" != "0" ]]
    then
...
do
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $badfile` -s localhost -p 8443 -H foo.example.com $vparm -f index.html
    else
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $badfile` -s localhost -p 8443 -H foo.example.com $vparm -f index.html >/dev/null 2>&1
    fi
    cret=$?
    # kill server
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
...
do
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html -S $sessfile
    else
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html -S $sessfile >/dev/null 2>&1
    fi
    cret=$?
    if [ ! -f $sessfile ]
    then
...
do
    ...
    if [[ "$verbose" == "yes" ]]
    then
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -R -w -k $scratchdir/$file $vparm &
    else
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -R -w -k $scratchdir/$file $vparm >/dev/null 2>&1 &
    fi
    # wait a bit
    sleep $sleepb4
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
...
do
    ...
    then
        ...
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -e -k $scratchdir/$file &
    else
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -e -k $scratchdir/$file $vparm >/dev/null 2>&1 &
    fi
    # wait a bit
    sleep $sleepb4
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
    ...
    if [[ "$verbose" == "yes" ]]
    then
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html -S $sessfile -e
    else
        $EDTOP/scripts/echcli.sh -P `$EDTOP/scripts/pem2rr.sh -p $file` -s localhost -p 8443 -H foo.example.com $vparm -f index.html -S $sessfile -e >/dev/null 2>&1
    fi
    cret=$?
    if [[ "$cret" != "0" ]]
    then
...
do
    ...
    then
        # took vparm out here - if it's there, something times out before tickets acquired
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -R -e -k $scratchdir/$file &
    else
        CFGTOP=$scratchdir $EDTOP/scripts/echsvr.sh -R -e -k $scratchdir/$file $vparm >/dev/null 2>&1 &
    fi
    # wait a bit
    sleep $sleepb4
    pids=`ps -ef | grep s_server | grep -v grep | awk '{print $2}'`
